...
public class ChangeAppearancePacketListener implements PacketListener {
    ...
    public void handleMessage(Player player, Packet packet) {
        ...
        player.getActionTracker().offer(new Action(Action.ActionType.CHANGE_APPEARANCE));
    ...
    private static final int[][] ALLOWED_COLORS = {
            ...
            {0, 15}, // legs color
            {0, 5}, // feet color
            {0, 9} // skin color, add to the second number when adding additional skin colors to client, array1003 in client.java
    };
