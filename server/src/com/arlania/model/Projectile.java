...
public final class Projectile {
    ...
    public Projectile(Position source, Position victimPos, Entity victim, int projectileId, int delay, int speed, int startHeight,
                      int endHeight, int curve) {
        this(source, victimPos,
                (victim.isPlayer() ? -victim.getIndex() - 1 : victim.getIndex() + 1), projectileId, delay, speed,
                startHeight, endHeight, curve);
    }


    public Projectile(Entity source, Entity victim, Position tile, int projectileId, int delay, int speed, int startHeight,
                      int endHeight, int curve) {
        this(source.getPosition(), tile,
                (victim.isPlayer() ? -victim.getIndex() - 1 : victim.getIndex() + 1), projectileId, delay, speed,
                startHeight, endHeight, curve);
    }
