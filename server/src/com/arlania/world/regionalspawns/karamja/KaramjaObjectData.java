...
public enum KaramjaObjectData {
    ...
    private int face;
    KaramjaObjectData(int objectId, Position spawnPosition, int face) {
    ...
    public static KaramjaObjectData load() {
        for (KaramjaObjectData misthalinObjectData : KaramjaObjectData.values()) {
