...
public enum CombatSpells {
    ...
    WIND_SURGE(new CombatNormalSpell() {
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(GameSettings.OSRS_ANIM_OFFSET + 7855));
        }

        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, GameSettings.OSRS_GFX_OFFSET + 1456, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1457, GraphicHeight.MIDDLE));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1455));
        }
    ...
    WATER_SURGE(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, GameSettings.OSRS_GFX_OFFSET + 1459, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1460, GraphicHeight.MIDDLE));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1458));
        }
        @Override
        public int baseExperience() {
            return 48;
    ...
    EARTH_SURGE(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, GameSettings.OSRS_GFX_OFFSET + 1462, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1463, GraphicHeight.MIDDLE));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1461));
        }
        @Override
        public int baseExperience() {
            return 50;
    ...
    FIRE_SURGE(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, GameSettings.OSRS_GFX_OFFSET + 1465, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1466, GraphicHeight.MIDDLE));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1464));
        }
        @Override
        public int baseExperience() {
            return 52;
        ...
        public void spellEffect(Character cast, Character castOn) {
            if (castOn.isPlayer()) {
                ...
                if (player.getTeleblockTimer() > 0) {
                    if (cast.isPlayer()) {
                        ((Player) cast).getPacketSender().sendMessage("The spell has no effect because the player is already teleblocked.");
                    }
                    return;
                }
                ...
                if (cast.isPlayer()) {
                    ((Player) cast).getPacketSender().sendMessage("All NPCs are completely immune to this particular spell.");
                }
            }
        }
    ...
    MAIDEN_BARRAGE(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            if (damage < 1) {
                return;
        ...
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(29353));
        }
    ...
    TRIDENT_SEAS(new CombatNormalSpell() {
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(14220));
        }
    ...
    SANGUINESTI(new CombatNormalSpell() {
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(14220));
        }
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, GameSettings.OSRS_GFX_OFFSET + 1539, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1542, GraphicHeight.MIDDLE));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(GameSettings.OSRS_GFX_OFFSET + 1540));
        }
    ...
    TUMEKEN(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 1917, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(1935, GraphicHeight.MIDDLE));
        }
