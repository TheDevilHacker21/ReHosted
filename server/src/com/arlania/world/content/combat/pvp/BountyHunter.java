...
public class BountyHunter {
    ...
    public static void process(Player player) {
        if (player.getPlayerKillingAttributes().getTarget() == null && (player.getPosition().getX() >= 3066 && player.getPosition().getX() <= 3105 && player.getPosition().getY() <= 3553)) {
        ...
        if (System.currentTimeMillis() - player.getPlayerKillingAttributes().getLastTargetPercentageIncrease() >= TARGET_PERCENTAGE_INCREASEMENT_TIMER && (player.getPosition().getX() >= 3066 && player.getPosition().getX() <= 3105 && player.getPosition().getY() <= 3553)) {
    ...
    public static void sequence(Player player) {
        if (player.getPlayerKillingAttributes().getTarget() != null) {
            if ((player.getPlayerKillingAttributes().getTarget().getLocation() != Location.WILDERNESS) || player.getPosition().getX() < 3066 || player.getPosition().getX() > 3105 || player.getPosition().getY() < 3523 || player.getPosition().getY() > 3553) {
    ...
    public static void assignTargets(Player player, Player target) {
        if (target == null || player == null)
            return;
        if (target.getPosition().getX() < 3066 || target.getPosition().getX() > 3105 || target.getPosition().getY() < 3523 || target.getPosition().getY() > 3553)
            return;
        if (player.getPosition().getX() < 3066 || player.getPosition().getX() > 3105 || player.getPosition().getY() < 3523 || player.getPosition().getY() > 3553)
            return;
