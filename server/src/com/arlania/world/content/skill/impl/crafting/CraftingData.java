...
public class CraftingData {
    ...
    public enum leatherDialogueData {
        ...
        GREEN_LEATHER(1745, 1065, 1135, 1099), BLUE_LEATHER(2505, 2487, 2499, 2493), RED_LEATHER(2507, 2489, 2501, 2495), BLACK_LEATHER(2509, 2491, 2503, 2497);
    ...
    public enum Leather {
        ...
        LEATHER_GLOVES(1733, 1741, 1059, 1, 1, 13.75),
        LEATHER_BOOTS(1733, 1741, 1061, 1, 7, 16.25);

        public int item1, leatherId, product, amountOfLeather, level;
        public double xp;

        Leather(int item1, int leatherId, int product, int amountOfLeather, int level, double xp) {
            this.leatherId = leatherId;
        ...
        public static Leather forId(int itemUsed, int usedWith) {
            for (Leather Data : Leather.values()) {
                if (Data.item1 == itemUsed && Data.leatherId == usedWith || Data.leatherId == itemUsed && Data.item1 == usedWith) {
                    return Data;
                }
            }
            return null;
    ...
    public enum leatherData {
        ...
        HARD_LEATHER_BODY(new int[][]{{10239, 1}, {10238, 5}, {6212, 28}}, 1743, 1131, 28, 35, 1),
        ...
        LACK_DHIDE_CHAPS(new int[][]{{34193, 1}, {34192, 5}, {34191, 10}, {34190, 28}}, 2509, 2497, 82, 172, 2);
