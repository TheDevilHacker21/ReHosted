...
public class NotedDecanting {


    public static void checkRequirements(Player player) {

        startDecanting(player);
        player.getPacketSender().sendMessage("@blu@Success! Your noted potions have been combined.");

    }

    public static void startDecanting(Player player) {
        for (NotedPotion p : NotedPotion.values()) {
            ...
            if (totalDoses > 0) {
                ...
                player.getInventory().add(230, totalEmptyPots);
            }
        }
