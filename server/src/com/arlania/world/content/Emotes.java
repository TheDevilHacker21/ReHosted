...
public class Emotes {
    ...
    public enum EmoteData {
        ...
        DRUNK(2769, new Animation(2769), null)
        ...
        public static EmoteData getRandomEmote() {
            int randomEmote = RandomUtility.inclusiveRandom(EmoteData.values().length - 1);
    ...
    public static boolean doEmote(final Player player, int buttonId) {
        ...
        if (emoteData != null) {
            ...
            if (data != null) {
                ...
                if (data != Skillcape_Data.QUEST_POINT && data != Skillcape_Data.ACHIEVEMENT) {
    ...
    public enum Skillcape_Data {
        ...
        QUEST_POINT(new int[]{9813, 9814, 10662},
                4945, 816, 19),
        ACHIEVEMENT(new int[]{219476, 213069},
                GameSettings.OSRS_ANIM_OFFSET + 2709, GameSettings.OSRS_GFX_OFFSET + 323, 25);
        ...
        private static final Map<Integer, Skillcape_Data> dataMap = new HashMap<Integer, Skillcape_Data>();
