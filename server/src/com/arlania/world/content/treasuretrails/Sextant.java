...
public class Sextant {
    ...
    public static void calculateStartFormula(Player c) {
        ...
        double randomBarDegree = -BAR_LIMIT_RIGHT
                ...
                + RandomUtility.inclusiveRandom((int) (BAR_LIMIT_RIGHT
        ...
        int incrementationSun = (RandomUtility.inclusiveRandom(1) == 0) ? RandomUtility
                .inclusiveRandom(limitDownSun) * 2 : -RandomUtility.inclusiveRandom(limitUpSun) * 2;
        // sextant landscape randomly placed
        double randomLandScapeDegree = -(GLOBAL_LIMIT_RIGHT / 5.7)
                + RandomUtility.inclusiveRandom((int) ((GLOBAL_LIMIT_RIGHT / 5.7) + (GLOBAL_LIMIT_LEFT / 5.7)));
        ...
        int incrementationLandScape = (RandomUtility.inclusiveRandom(1) == 0) ? RandomUtility
                .inclusiveRandom(limitDownLandScape) : -RandomUtility.inclusiveRandom(limitUpLandScape);
