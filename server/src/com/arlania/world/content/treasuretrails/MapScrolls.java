...
public class MapScrolls {
    ...
    public enum MapCluesData {
        ...
        private static final Map<Position, MapCluesData> positions = new HashMap<Position, MapCluesData>();
        private static final Map<Integer, MapCluesData> clues = new HashMap<Integer, MapCluesData>();
    ...
    public static int getRandomScroll(int level) {
        int pick = RandomUtility.RANDOM.nextInt(MapCluesData.values().length);
        while (MapCluesData.values()[pick].getLevel() != level) {
            pick = RandomUtility.RANDOM.nextInt(MapCluesData.values().length);
        }
    ...
    public static boolean handleCrate(Player player, int objectX, int objectY) {
        ...
        InactiveClueScroll.clueReward(player, mapCluesData.getLevel(),
