...
public class DiggingScrolls {
    ...
    public enum DigData {
        ...
        private final Position diggingPosition;
        private final int level;

        private static final Map<Integer, DigData> clues = new HashMap<Integer, DigData>();
        private static final Map<Position, DigData> positions = new HashMap<Position, DigData>();
    ...
    public static int getRandomScroll(int level) {
        int pick = RandomUtility.RANDOM.nextInt(DigData.values().length);
        while (DigData.values()[pick].getLevel() != level) {
            pick = RandomUtility.RANDOM.nextInt(DigData.values().length);
        }
