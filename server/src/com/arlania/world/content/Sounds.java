...
public class Sounds {
    ...
    public enum Sound {
        ...
        public int getSound() {
            return sounds[RandomUtility.inclusiveRandom(getSounds().length - 1)];
        }
    }
    ...
    public static int getNpcAttackSounds(int NPCID) {
        ...
        return RandomUtility.inclusiveRandom(6) > 3 ? 398 : 394;
    }
    ...
    public static int getPlayerAttackSound(Player c) {
        ...
        if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4718 || c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 7808) { //Dharok GreatAxe
            return 400;
        }
