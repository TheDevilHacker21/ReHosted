...
public class PlayerUpdating {
    ...
    private static void updateChat(PacketBuilder builder, Player target) {
        ...
        builder.put(target.getStaffRights().ordinal());
    ...
    private static void updateAppearance(Player player, PacketBuilder out, Player target) {
        ...
        Overrides overrides = target.getOverrides();
        ...
        int[] override = new int[overrides.capacity()];
        if (player.getNpcTransformationId() <= 0) {

            for (int i = 0; i < equipment.capacity(); i++) {
                equip[i] = equipment.getItems()[i].getId();
                override[i] = overrides.getItems()[i].getId();
            }

            //head check
            if (player.overrideAppearance > 0 && override[Overrides.HEAD_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.HEAD_SLOT]);
            ...
            //cape check
            if (player.overrideAppearance > 0 && override[Overrides.CAPE_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.CAPE_SLOT]);
                if (override[Overrides.CAPE_SLOT] == 14019 || override[Overrides.CAPE_SLOT] == 14022) {

                } else {
                    properties.put(0);
                }
            } else if (equip[Equipment.CAPE_SLOT] > -1) {
            ...
            //amulet check
            if (player.overrideAppearance > 0 && override[Overrides.AMULET_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.AMULET_SLOT]);
            } else if (equip[Equipment.AMULET_SLOT] > -1) {
            ...
            //weapon check
            if (equip[Equipment.WEAPON_SLOT] > -1 && equip[Equipment.WEAPON_SLOT] < GameSettings.OSRS_ITEMS_OFFSET) {
            ...
            //body check
            if (player.overrideAppearance > 0 && override[Overrides.BODY_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.BODY_SLOT]);
            ...
            //full body graphical check
            if (player.overrideAppearance > 0 && override[Overrides.BODY_SLOT] > -1 && ItemDefinition.forId(override[Overrides.BODY_SLOT]).isFullBody()) {
                properties.put(0);
            } else if (ItemDefinition.forId(override[Overrides.BODY_SLOT]).isFullBody()) {
                properties.put(0);
            } else {
            ...
            //legs check
            if (player.overrideAppearance > 0 && override[Overrides.LEG_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.LEG_SLOT]);
            ...
            //full helm check
            if (player.overrideAppearance > 0 && override[Overrides.HEAD_SLOT] > -1 && ItemDefinition.forId(override[Overrides.HEAD_SLOT]).isFullHelm()) {
                properties.put(0);
            ...
            //hands check
            if (player.overrideAppearance > 0 && override[Overrides.HANDS_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.HANDS_SLOT]);
            ...
            //feet check
            if (player.overrideAppearance > 0 && override[Overrides.FEET_SLOT] > -1) {
                properties.putShort(0x200 + override[Overrides.FEET_SLOT]);
            ...
            if (player.overrideAppearance > 0 && override[Overrides.HEAD_SLOT] > -1 && ItemDefinition.forId(override[Overrides.HEAD_SLOT]).isFullHelm()) {
                properties.put(0);
            } else if (appearance.getLook()[Appearance.BEARD] <= 0 || appearance.getGender().equals(Gender.FEMALE) || ItemDefinition.forId(equip[Equipment.HEAD_SLOT]).isFullHelm()) {
                properties.put(0);
            } else {
        ...
        properties.putShort(target.getStaffRights().ordinal());
        properties.putString(target.getTitle());


        for (int i = 0; i < equipment.capacity(); i++) {
            if(player.overrideAppearance > 0) {
                if (override[i] > GameSettings.OSRS_ITEMS_OFFSET && override[i] > 0) {
                    if (i != 6 && i != 8 && i != 11) {
                        properties.putInt(0x200 + override[i]);
                    } else if (i == 6) {//full body graphical check
                        if (override[Overrides.BODY_SLOT] > -1 && ItemDefinition.forId(override[Overrides.BODY_SLOT]).isFullBody()) {
                            properties.put(0);
                        } else if (ItemDefinition.forId(override[Overrides.BODY_SLOT]).isFullBody()) {
                            properties.put(0);
                        } else {
                    ...
                    } else if (i == 8 && !ItemDefinition.forId(override[Overrides.HEAD_SLOT]).isFullHelm()) {
                        properties.putShort(0x100 + appearance.getLook()[Appearance.HEAD]);
                    } else if (i == 11) {
                        if (override[Overrides.HEAD_SLOT] > -1 && ItemDefinition.forId(override[Overrides.HEAD_SLOT]).isFullHelm()) {
                            properties.put(0);
                        } else if (appearance.getLook()[Appearance.BEARD] <= 0 || appearance.getGender().equals(Gender.FEMALE) || ItemDefinition.forId(override[Overrides.HEAD_SLOT]).isFullHelm()) {
                            properties.put(0);
                        } else {
                            properties.putShort(0x100 + appearance.getLook()[Appearance.BEARD]);
                        }
                ...
                if (equip[i] > GameSettings.OSRS_ITEMS_OFFSET && equip[i] > 0) {
                    if (i != 6 && i != 8 && i != 11) {
                        properties.putInt(0x200 + equip[i]);
                    } else if (i == 6) {//full body graphical check
                        if (equip[Equipment.BODY_SLOT] > -1 && ItemDefinition.forId(equip[Equipment.BODY_SLOT]).isFullBody()) {
                            properties.put(0);
                        } else if (ItemDefinition.forId(equip[Equipment.BODY_SLOT]).isFullBody()) {
                            properties.put(0);
                        } else {
                            properties.putShort(0x100 + appearance.getLook()[Appearance.ARMS]);
                        }
                    } else if (i == 8 && !ItemDefinition.forId(equip[Equipment.HEAD_SLOT]).isFullHelm()) {
                        properties.putShort(0x100 + appearance.getLook()[Appearance.HEAD]);
                    } else if (i == 11) {
                        if (equip[Equipment.HEAD_SLOT] > -1 && ItemDefinition.forId(equip[Equipment.HEAD_SLOT]).isFullHelm()) {
                            properties.put(0);
                        } else if (appearance.getLook()[Appearance.BEARD] <= 0 || appearance.getGender().equals(Gender.FEMALE) || ItemDefinition.forId(equip[Equipment.HEAD_SLOT]).isFullHelm()) {
                            properties.put(0);
                        } else {
                    ...
                    if (i == 10 && equip[Equipment.LEG_SLOT] == 223894 && equip[Equipment.FEET_SLOT] < 0) {
                        properties.putShort(0x200 + 211840);
        ...
        if (player.getEquipment().forSlot(3).getId() > -1) {
            WeaponAnimations.assign(player, player.getEquipment().forSlot(3));
        }
        properties.putString("Null");
